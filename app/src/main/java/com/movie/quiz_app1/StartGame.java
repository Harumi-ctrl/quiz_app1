...
public class StartGame extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        techList.add("1/2");///////この場所と下の一個目が繋がって正解になっていて他の間違ってるのはランダムに割り当てられる
        techList.add("log2");
        techList.add("π/4+1/2");
        techList.add("1-π/4");
        techList.add("3π/8");
        techList.add(" 8log4−15/4");
        techList.add("45/4");
        techList.add("1");
      //  techList.add("1");
        techList.add("3/4");
      ...
      //  techList.add("Nodejs");
        ...
        map.put(techList.get(0), R.drawable.s1);
        map.put(techList.get(1), R.drawable.s2);
        map.put(techList.get(2), R.drawable.s3);
        map.put(techList.get(3), R.drawable.s4);
        map.put(techList.get(4), R.drawable.s5);
        map.put(techList.get(5), R.drawable.s6);
        map.put(techList.get(6), R.drawable.s7);
        map.put(techList.get(7), R.drawable.s8);
     //   map.put(techList.get(8), R.drawable.s9);
        map.put(techList.get(8), R.drawable.s10);
        map.put(techList.get(9), R.drawable.s11);
 //       map.put(techList.get(11), R.drawable.s12);
   //     map.put(techList.get(12), R.drawable.s13);
     //   map.put(techList.get(13), R.drawable.s14);
       // map.put(techList.get(14), R.drawable.s15);
       // map.put(techList.get(15), R.drawable.s16);
